// This component is now much simpler. It no longer manages its own state.
// It just renders the data it's given.

// A simple checkmark icon using SVG
const CheckmarkIcon = () => (
...
// A simple circle icon for pending tasks
const CircleIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-circle me-2 text-secondary" viewBox="0 0 16 16">
    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
  </svg>
);

export default function TaskProgress({ tasks = [] }) {
  // Derive counts directly from props
